...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addItem('作業リストを更新', 'refreshWorkListSheet')
    .addItem('部品リストを更新', 'refreshPartsListSheet')
    .addItem('リストをまとめて更新（順番・選択肢）', 'refreshAllMasterLists')
    .addItem('テンプレートリストを更新（順番）', 'refreshInvoiceTemplateList')
